...
<section class="content  style=" padding:20px"">
    <div class="container-fluid">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('admin.users.update', $user->id)}}" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" id="first_name" class="form-control" value="{{$user->profile->first_name}}" placeholder="Enter First Name">
                                        <span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email" name="email" value="{{$user->email}}" class="form-control" placeholder="Enter Your Email-Address">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="c_password">Confirm Email</label>
                                        <input type="email" id="email" name="email_confirmation" value="{{$user->email}}" id="email_confirmation" class="form-control" placeholder="Re-Enter Your Email-Address">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="phone" id="phone" name="phone" value="{{$user->profile->phone}}" class="form-control">
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-inline btn-primary">Update User detail</button>
                    </div>
            </form>
        </div>
        <!-- /.card -->
